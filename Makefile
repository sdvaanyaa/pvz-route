...
#	@curl -sSL https://raw.githubusercontent.com/googleapis/googleapis/master/google/api/http.proto -o vendor.protogen/google/api/http.protonstall github.com/grpc-ecosystem/grpc-gateway/v2/protoc-gen-openapiv2@latest